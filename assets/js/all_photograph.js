  ...
  photographers.forEach((element) => {
    let photographHTML = `
        <article class='d-flex column'>
          <figure class='profil-pic'><a href='/pages/photograph.html?id=${element.id}'><img src='assets/img/Sample_Photos/Photographers_ID_Photos/${element.portrait}' alt='${element.alt}' /></a></figure>
    ...
    element.tags.forEach((tag) => {
      photographHTML += `<li class='tags'><a href='?tag=${tag}'>#${tag}</a></li>`;
    });
    photographHTML += `</ul>
    </div>
    </article>`;
